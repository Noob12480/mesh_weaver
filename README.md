...
---
 ...
 <img src="screenshot/textured.png" width="765"> 
---
###
该版本实现了基础cpu软光栅渲染器以及部分优化（视锥裁剪、背面剔除等），并支持.obj模型导入、单张纹理贴图。
...
2. Shift、Space控制上下移动
3. 右键+移动鼠标控制摄像机朝向
4. 按R切换着色模型(目前支持Flat Shading和Phong Shading)
...
基于已实现的软光栅渲染器与网格数据结构，进行几何算法实验与开发，扩展为网格处理系统